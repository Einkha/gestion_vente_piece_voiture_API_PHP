<?php
    ...
    if($_GET)
    {
                            ...
                            if($reponse) 
                            {
                                ...
                                try {
                                    ...
                                    if($reponse)
                                    {
                                        ...
                                        $requete_stock_update = "UPDATE vente_piece_voiture.piece_voiture SET nombre_stock=:stockTotal WHERE id_piece_voiture=:idPieceVoiture";
                                        ...
                                        try {
                                            ...
                                            $requete_2 = $baseDeDonnees->prepare($requete_stock_update);
        ...
        if ($action == "modificationVente")
        {
            ...
            if (empty($idVente) || empty($Quantite) || empty($dateAchat) || !preg_match('/vente[0-9]+/', $idVente) || !is_numeric($Quantite) || !strtotime($dateAchat))
            {
                $resultat['erreur'] = true;
                    ...
                    else
                    {
                        ...
                        try 
                        {
                            ...
                            else
                            {
                                ...
                                $requete_stock_update = "UPDATE vente_piece_voiture.vente SET quantite=:Quantite WHERE id_vente=:idVente";
                                ...
                                try 
                                {
                                    ...
                                    if($reponse_2)
                                    {
                                        $requete_modification_piece = "UPDATE vente_piece_voiture.piece_voiture SET nombre_stock=:nouveauStock WHERE id_piece_voiture=:idPieceVoiture";
                                        
                                        $requete_3 = $baseDeDonnees->prepare($requete_modification_piece);
                                        $requete_3->bindValue(':idPieceVoiture', $idPieceVoiture);

                                        $requete_3->bindValue(':nouveauStock', $nouveauStock);
                                        $requete_3->execute();
